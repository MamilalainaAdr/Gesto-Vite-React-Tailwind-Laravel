...
export default function DeleteProduct ({cancel, confirm, isOpen, update, product}){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                messageAPI.success('Produit effacé avec succès')
            } else {
    ...
    return(<>
        ...
        <Modal title="Effacer produit" okText='Effacer' onCancel={cancel} onOk={handleSubmit} open={isOpen}>
            <p>Êtes-vous sûr(e) de vouloir effacer ce produit?</p>
        </Modal>
        </>
    )
}